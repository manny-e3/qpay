...
<head>
    ...
    <style>
        ...
        .items-table tr.item-row td {
            height: 180px; /* Provides the spacing as seen in design */
        }
    ...
    <div class="outer-frame">
        ...
        <table class="info-grid">
            <tr>
                ...
                <td class="value">{{ $transaction->updated_at ? $transaction->updated_at->format('M d, Y') : date('M d, Y') }}</td>
            </tr>
            <tr>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr class="total-row">
                    <td style="border: none;"></td>
                    <td class="text-right total-paid-label">TOTAL PAID</td>
                    <td class="text-right total-paid-value">{{ number_format($transaction->amount, 2) }}</td>
                </tr>
            </tbody>
        </table>
